...
function startBarcodeScanner() {
  ...
  Quagga.init({
    ...
    if (err) {
      ...
      resultDiv.innerHTML = '<div style="padding: 12px; color: var(--danger); font-size: 13px; text-align: center;">⚠️ Camera error: ' + err.message + '<br><br>Please:<br>1. Allow camera access<br>2. Try refreshing the page<br>3. Check camera is not used by another app</div>';
    ...
    Quagga.start();
    resultDiv.innerHTML = '<div style="text-align: center; padding: 12px; color: var(--acc); font-size: 13px; font-weight: 700;">📱 Point camera at barcode...</div>';
  });
