...
function calcTDEE() {
  ...
  // Macro split (40/30/30 - protein/carb/fat for balanced approach)
  var proteinCals = target * 0.40;
  var carbCals = target * 0.30;
  var fatCals = target * 0.30;
  ...
  document.getElementById('tdee-protein').textContent = proteinGrams + 'g';
  document.getElementById('tdee-carbs').textContent = carbGrams + 'g';
  document.getElementById('tdee-fat').textContent = fatGrams + 'g';
