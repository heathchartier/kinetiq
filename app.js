...
function startBarcodeScanner() {
  ...
  resultDiv.innerHTML = '<div style="text-align: center; padding: 12px; color: var(--t2); font-size: 13px;">📱 Point camera at barcode...</div>';
  ...
  Quagga.init({
    ...
    if (err) {
      ...
      resultDiv.innerHTML = '<div style="padding: 12px; color: var(--danger); font-size: 13px; text-align: center;">⚠️ Camera access denied or not available. Please allow camera access and try again.</div>';
      return;
    }
