// ============================================================================
// AUTH UI HANDLERS - v2.1.0 (Password Reset + Sync Fixes)
// ============================================================================
...
// Show password reset modal (called when user clicks reset link)
...
async function handlePasswordReset() {
  ...
  try {
    ...
    // IMPORTANT: Sync data from cloud after password reset
    // This ensures user gets their existing data, not treated as new user
