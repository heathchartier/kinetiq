...
function renderAchievements() {
  ...
  let html = `
    <div class="achievements-header">
      <h2>🏆 Achievements</h2>
      <p class="achievements-stats">${unlocked.length} / ${Object.keys(ACHIEVEMENTS).length} Unlocked</p>
    </div>
  `;
...
function showAchievementsModal() {
  ...
  modal.innerHTML = `
    <div class="modal-content achievements-modal-content">
      <button class="close-btn" onclick="document.getElementById('achievements-modal').remove()">×</button>
      ${renderAchievements()}
    </div>
  `;
